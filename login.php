...
.auth-wrap {
    ...
    padding: 40px 16px;
    background: linear-gradient(rgba(0, 74, 173, 0.75), rgba(0, 33, 71, 0.9)), url('gt_pic/library.jpg') center/cover no-repeat;
}
.auth-box {
    background: #fff;
    border: none;
    ...
    <div class="auth-box">
        ...
        <form method="POST">
            ...
            <div style="text-align:right; margin-top:-10px; margin-bottom:18px;">
                <a href="#" style="font-size:12px; color:#64748b;">Forgot password?</a>
            </div>
