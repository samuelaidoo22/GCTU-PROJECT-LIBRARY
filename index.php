...
.hero {
    background: #004AAD;
    background-image: url('gt_pic/gatehouse.jpg');
...
.hero::before {
    ...
    background: rgba(0, 55, 130, 0.82);
}
.hero-inner { position: relative; z-index: 1; }
.hero h1 { font-size: 34px; font-weight: 700; color: #fff; margin-bottom: 12px; }
.hero p  { color: rgba(255,255,255,0.8); font-size: 16px; margin-bottom: 28px; max-width: 560px; }
